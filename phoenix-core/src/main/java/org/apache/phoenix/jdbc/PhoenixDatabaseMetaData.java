...
public class PhoenixDatabaseMetaData implements DatabaseMetaData {
    ...
    public static final String VIEW_INDEX_ID_ENCODING_SCHEME = "VIEW_INDEX_ID_ENCODING_SCHEME";
    public static final byte[] VIEW_INDEX_ID_ENCODING_SCHEME_BYTES = Bytes.toBytes(VIEW_INDEX_ID_ENCODING_SCHEME);
